...
for k1 = 1:6
    for k2 = 1:6
        %separando por k1 e k2 e criando um vetor descartï¿½vel a cada loop
        %para uma faixa de frequï¿½ncia de 1 atï¿½ esse limite data.hydro.freqs
        for k3 = 1:length(data.hydro.freqs); %k3 representa a variaï¿½ï¿½o de frequencia e k1 e k2 a combinaï¿½ï¿½o dos graus de liberdade
        ...
        %algoritmo para interpolaï¿½ï¿½o de uma frequï¿½ncia fixa
        A11_fixfreq(k1,k2) = interp1(data.hydro.freqs,A11,w);%essa frequencia w nï¿½o ï¿½ repesentativa!
