function [Krad,Ainf_hat] = FDIRadMod_alt(W,A,Ainf,B,FDIopt,Dof)
...
if FDIopt.AinfFlag==1,
    ...
    [Ks]=ident_retardation_FD_alt(W,Kw,FDIopt.Ord,MethOpt,PlotOpt);
    %
...
if FDIopt.AinfFlag==0,
    ...
    %Auto order estimates
    FDIopt.Ord = 2;
    [As]=ident_retardation_FD_altna(W,Ac,FDIopt.Ord,MethOpt,PlotOpt);
    %
...
% figure(1)
% subplot(2,1,1)
% semilogx(W,20*log10(abs(Kw)))
% grid on
% subplot(2,1,2)
% semilogx(W,180/pi*phase(Kw))
% grid on
% 
% figure(2)
% bode(Krad)
