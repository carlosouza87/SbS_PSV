function [etap,nup] = eqmotions_6(eta,nu,rg1,rg2,Mrb,A,G,mu,tau)
% function [etap,nup] = eqmotions_6(eta,nu,rg1,rg2,Mrb,A,G,mu,tau)
% Calculation of the 6 DOF equations of motion for both ships. Fluid memory
% effects can be considered if the convolution integral of cummins equation
% is calculated externally and stored in the mu vector, for isimtype = 1.
% For isimtype = 2 the function calculates the low-frequency, maneuvering
% equations of motion.
%
...
% A - Added inertia matrix for both vessels, including couplings. For 
%     isimtype = 1 it must be composed of the asymptotic infinite-frequency
%     added-mass coefficients, while for isimtype = 2 the zero-frequency 
%     coefficents are to be used [12x12]
