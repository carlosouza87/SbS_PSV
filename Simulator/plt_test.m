...
figure(1)
subplot(3,2,1)
plot(freqs_wam,a12_wam_11)
hold on
plot(freqs_old,a12_old_11,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{11} - FPSO on PSV [t]')
subplot(3,2,2)
plot(freqs_wam,b12_wam_11)
hold on
plot(freqs_old,b12_old_11,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('b_{11} - FPSO on PSV [kN.s/m]')
subplot(3,2,3)
plot(freqs_wam,a12_wam_22)
hold on
plot(freqs_old,a12_old_22,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{22} - FPSO on PSV [t]')
subplot(3,2,4)
plot(freqs_wam,b12_wam_22)
hold on
plot(freqs_old,b12_old_22,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('b_{22} - FPSO on PSV [kN.s/m]')
subplot(3,2,5)
plot(freqs_wam,a12_wam_66)
hold on
plot(freqs_old,a12_old_66,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{66} - FPSO on PSV [t.m]')
subplot(3,2,6)
plot(freqs_wam,b12_wam_66)
hold on
plot(freqs_old,b12_old_66,'r')
grid on
xlabel('Frequency (rad/s)')
...
figure(2)
subplot(3,2,1)
plot(freqs_wam,a22_wam_11)
hold on
plot(freqs_old,a22_old_11,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{11} - PSV [t]')
subplot(3,2,2)
plot(freqs_wam,b22_wam_11)
hold on
plot(freqs_old,b22_old_22,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('b_{11} - PSV [kN.s/m]')
subplot(3,2,3)
plot(freqs_wam,a22_wam_22)
hold on
plot(freqs_old,a22_old_22,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{22} - PSV [t]')
subplot(3,2,4)
plot(freqs_wam,b22_wam_22)
hold on
plot(freqs_old,b22_old_22,'r')
grid on
xlabel('Frequency (rad/s)')
...
subplot(3,2,5)
plot(freqs_wam,a22_wam_66)
hold on
plot(freqs_old,a22_old_66,'r')
grid on
xlabel('Frequency (rad/s)')
ylabel('a_{66} - PSV [t.m]')
subplot(3,2,6)
plot(freqs_wam,b22_wam_66)
hold on
plot(freqs_old,b22_old_66,'r')
grid on
xlabel('Frequency (rad/s)')
